...
>
    ...
    >
        <!-- Background gradient -->
        <div
            class="absolute inset-0 bg-gradient-to-b from-[#0f1014] via-[#0a0a0b] to-[#0a0a0b]"
        ></div>
        ...
        <div class="relative z-10 h-full flex flex-col p-[5%]">
            ...
            <header class="text-center mb-auto">
                {#if appStore.userName}
                    <p class="text-[28px] font-medium text-zinc-400 mb-2">
                        {appStore.userName}'s
                    </p>
                {/if}
                <h1 class="text-[64px] font-bold tracking-tight glow-text">
                    2025
                </h1>
                <p class="text-[24px] text-zinc-500 font-medium">
                    Year in Sport
                </p>
            </header>
            ...
            <div class="grid grid-cols-2 gap-6 mb-8">
                <div class="export-stat-card">
                    ...
                    <div
                        class="text-[48px] font-bold stat-value text-white leading-none"
                    >
                        {formatDistance(appStore.stats?.totalDistance ?? 0)}
                    </div>
                    <div
                        class="text-[18px] font-medium text-zinc-500 uppercase tracking-wider mt-1"
                    >
                        Total Distance
                    </div>
                </div>
            ...
            <div class="grid grid-cols-2 gap-6 mb-8">
                <div class="export-stat-card highlight">
                    ...
                    <div
                        class="text-[56px] font-bold stat-value text-white leading-none"
                    >
                        {appStore.stats?.activeDays ?? 0}
                    </div>
                    <div
                        class="text-[16px] font-medium text-zinc-500 uppercase tracking-wider mt-1"
                    >
                        Active Days
                    </div>
                </div>
            ...
            {#if appStore.records}
                <div class="mb-8">
                    <h2
                        class="text-[20px] font-semibold text-zinc-400 mb-4 uppercase tracking-wider"
                    >
                        Personal Records
                    </h2>
                    <div class="grid grid-cols-3 gap-4">
                        {#if appStore.records.longestDistance}
                            <div class="export-record-card">
                                ...
                                />
                                <div
                                    class="text-[28px] font-bold stat-value text-white"
                                >
                                    {formatDistance(
                                ...
                                <div
                                    class="text-[12px] text-zinc-500 uppercase tracking-wide"
                                >
                                    Longest
                                </div>
                            </div>
                    ...
                    <div class="grid grid-cols-4 gap-3">
                        {#each topSports as sport}
                            ...
                            <div class="export-sport-card">
                                ...
                                <div class="text-[14px] text-zinc-500">
                                    {sport.count}×
                                </div>
                            </div>
                        {/each}
            ...
            <div class="mt-auto pt-6 text-center">
                <p class="text-[16px] text-zinc-600 font-medium">
                    activeyear.app
                </p>
            </div>
        </div>
