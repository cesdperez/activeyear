...
<svelte:head>
	...
	<meta name="description" content="Generate beautiful shareable infographics from your Garmin activity data. All processing happens in your browser - your data never leaves." />
</svelte:head>
	...
	{:else}
		...
		<div class="min-h-screen flex flex-col items-center justify-center px-4">
			...
			<div class="mt-12 text-center max-w-md">
				<h2 class="text-sm font-medium text-zinc-400 mb-4">How to get your data</h2>
				<ol class="text-left text-sm text-zinc-500 space-y-2">
					<li class="flex gap-2">
						<span class="text-cyan-400 font-mono">1.</span>
						Log in at <a href="https://connect.garmin.com" target="_blank" class="text-cyan-400 hover:underline">connect.garmin.com</a>
					</li>
					<li class="flex gap-2">
